 ...
 * @subpackage Skins
 */
class SkinGTALUG extends SkinTemplate {
	/** Using gtalug. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'gtalug';
		$this->stylename = 'gtalug';
		$this->template  = 'GTALUGTemplate';
	}
}
 ...
 * @subpackage Skins
 */
class GTALUGTemplate extends QuickTemplate {
	/**
	 * Template filter callback for GTALUG skin.
